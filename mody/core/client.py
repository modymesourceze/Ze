...
class ZeUserBotClient(TelegramClient):
    def ze_cmd(
        self: TelegramClient,
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @D_S_I\
                                  \n\n--------بـدء تتبـع سجـل زد إي 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع زد إي 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱--------"
                        ...
                        link = "[𐇮 𝑴𝑶𝑫𝒀 𖠮🚸𖠮 آلـۘهہؚيـٰـ‌ُـُ໋۠بـ໋ۘ۠ه 𐇮](https://t.me/D_S_I)"
                        text = (
                            "**✘ تقـريـر اشعـار زد إي 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 ✘**\n\n"
            ...
            if pattern is not None:
                ...
                if edited:
                    zeub.add_event_handler(func, events.MessageEdited(**kwargs))
                zeub.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار زد إي 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 ✘**\n\n "
                        link = "[𐇮 𝑴𝑶𝑫𝒀 𖠮🚸𖠮 آلـۘهہؚيـٰـ‌ُـُ໋۠بـ໋ۘ۠ه 𐇮](https://t.me/D_S_I)"
            ...
            if edited is True:
                zeub.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                zeub.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
...
ZeUserBotClient.fast_download_file = download_file
ZeUserBotClient.fast_upload_file = upload_file
ZeUserBotClient.reload = restart_script
ZeUserBotClient.get_msg_link = get_message_link
ZeUserBotClient.check_testcases = checking
try:
    send_message_check = TelegramClient.send_message
except AttributeError:
    ZeUserBotClient.send_message = send_message
    ZeUserBotClient.send_file = send_file
    ZeUserBotClient.edit_message = edit_message
