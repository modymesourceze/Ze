...
from mody import zeub, zeversion, StartTime
from ..Config import Config
from ..helpers.functions import rand_key, zealive, check_data_base_heal_th, get_readable_time
        ...
        if match or match2 or match3:
            ...
            if match3:
                ...
                for user in users:
                    ...
                    sandy += " "
                sandy = sandy[:-1]
            old_msg = os.path.join("./mody", f"{info_type[0]}.txt")
            try:
