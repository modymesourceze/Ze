...
async def yt_search(ze):
    try:
        ze = urllib.parse.quote(ze)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={ze}"
        )
...
"""
async def yt_data(ze):
    params = {"format": "json", "url": ze}
