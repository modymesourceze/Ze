...
from wand.image import Image as zeimage

from .utils import _zeutils
...
async def ze_meme(CNG_FONTS, topString, bottomString, filename, endname):
...
async def ze_meeme(upper_text, lower_text, CNG_FONTS, picture_name, endname):
    main_image = zeimage(filename=picture_name)
    main_image.resize(
