...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 𓆪 </b> - @source_ze "
...
@zeub.ze_cmd(pattern="حيوان(?: |$)(.*)")
async def who(event):
    ze = await edit_or_reply(event, "⇆")
    mod_dev = (6581896306, 6756092971)
    ...
    try:
        ...
        return await edit_or_reply(ze, "**- لـم استطـع العثــور ع الشخــص**")
    if replied_user.id in mod_dev:
       return await edit_or_reply(ze, "**- دي . . انـهُ احـد المطـورين . . انتـه الحيـوان ولك**")
    if replied_user.id == 6756092971 or replied_user.id == 6581896306:
       return await edit_or_reply(ze, "**- دي . . انـهُ المطـور . . انتـه الحيـوان ولك**")
    ...
    try:
        ...
        await ze.edit(caption, parse_mode="html")
