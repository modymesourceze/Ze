...
ModyVP_cmd = (
    "𓆩 [🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامـر الفـارات](t.me/source_ze) 𓆪\n\n"
    ...
    "⪼ `.اضف كليشة الايدي` بالـرد ع الكليشـه مـن القنـاة @source_ze \n\n\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @source_ze\n\n"
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if not vinfo.startswith("@"):
            return await ze.edit("**☣╎خطـأ .. قم بالـرد ع يـوزر فقـط**")
        vinfo = vinfo.replace("@", "")
        if gvarstatus("START_TEXT") is None:
            await ze.edit("**☣╎تم تغييـر {} بنجـاح ☑️**\n**☣╎رابـط زر كليشـة الستـارت الجـديـد** \nhttps://t.me/{} \n\n**☣╎الان قـم بـ الذهـاب لبوتك المسـاعد من حساب آخر ↶** ودز ستارت **لـ التحقـق مـن الكليشـة . .**".format(input_str, vinfo))
        else:
            await ze.edit("**☣╎تم إضـافـة {} بنجـاح ☑️**\n**☣╎رابـط زر كليشـة الستـارت الجـديـد** \nhttps://t.me/{} \n\n**☣╎الان قـم بـ الذهـاب لبوتك المسـاعد من حساب آخر ↶** ودز ستارت **لـ التحقـق مـن الكليشـة . .**".format(input_str, vinfo))
        ...
        variable = "CUSTOM_ALIVE_EMZE"
        await asyncio.sleep(1.5)
        if gvarstatus("CUSTOM_ALIVE_EMZE") is None:
        ...
        if gvarstatus("DEFAULT_BIO") is None:
            ...
            addgvar(variable, vinfo)
            await ze.edit("**☣╎تم اضـافه {} بنجـاح ☑️**\n**☣╎البـايـو المضـاف** \n {} \n\n**☣╎الان قـم بـ ارسـال الامـر ↶** `.البايو تلقائي` **لـ التحقـق مـن البايـو . .**".format(input_str, vinfo))
        ...
        if vinfo.isdigit():
            ...
            return await ze.edit("**☣╎خطـأ .. قم بالـرد ع رقـم فقـط ؟!**")
        heroku_var[variable] = vinfo
        ...
        if input_str:
            return await ze.edit("**☣╎عـذࢪاً .. لايوجـد هنالك فـار بإسـم {} ؟!.. ارسـل (.اوامر الفارات) لـعرض قائمـة الفـارات**".format(input_str))
...
# Copyright (C) 2023 Ze . All Rights Reserved
@zeub.ze_cmd(pattern="حذف فار(?:\s|$)([\s\S]*)")
async def variable(event):
    ...
    heroku_var = app.config()
    ze = await edit_or_reply(event, "**☣╎جـاري حـذف الفـار مـن بـوتك 🚮...**")
    # All Rights Reserved for "Ze" "مودي الهيبـه"
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        variable = gvarstatus("ALIVE_TEMPLATE")
        await asyncio.sleep(1.5)
        if gvarstatus("ALIVE_TEMPLATE") is None:
        	return await ze.edit("**☣╎عـذࢪاً عـزيـزي .. انت لـم تقـم باضـافـة فـار {} اصـلاً...**".format(input_str))
        await ze.edit("**☣╎تم حـذف {} بنجـاح ☑️**\n**☣╎المتغيـر المحـذوف : ↶**\n `{}` \n**☣╎يتم الان اعـادة تشغيـل بـوت زد ثـون يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, variable))
        ...
        if gvarstatus("ZID_TEMPLATE") is None:
        	return await ze.edit("**☣╎عـذࢪاً عـزيـزي .. انت لـم تقـم باضـافـة فـار {} اصـلاً...**".format(input_str))
        await ze.edit("**☣╎تم حـذف فـار {} . . بنجـاح ☑️**".format(input_str))
...
# Copyright (C) 2023 Ze . All Rights Reserved
@zeub.ze_cmd(pattern="جلب فار(?:\s|$)([\s\S]*)")
async def custom_ze(event):
    input_str = event.text[9:]
    ze = await edit_or_reply(event, "**☣╎جــاري جلـب معلـومـات الفــار 🛂. . .**")
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        variable = gvarstatus("pmpermit_txt")
        if variable is None:
            await ze.edit("**☣╎فـار كليشـة الحمايـة غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الكليشـة استخـدم الامـر : ↶**\n `.اضف فار كليشة الحماية` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
            
    elif input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        variable = gvarstatus("ALIVE_TEMPLATE")
        if variable is None:
            await ze.edit("**☣╎فـار كليشـة الفحص غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الكليشـة استخـدم الامـر : ↶**\n `.اضف فار كليشة الفحص` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = gvarstatus("START_TEXT")
        if variable is None:
            await ze.edit("**☣╎فـار كليشـة البـوت غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الكليشـة استخـدم الامـر : ↶**\n `.اضف فار كليشة البوت` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = gvarstatus("pmblock")
        if variable is None:
            await ze.edit("**☣╎فـار كليشـة الحظـر غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الكليشـة استخـدم الامـر : ↶**\n `.اضف فار كليشة الحظر` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))

    elif input_str == "رمز الوقتي" or input_str == "رمز الاسم الوقتي":
        variable = gvarstatus("CUSTOM_ALIVE_EMZE")
        if variable is None:
            await ze.edit("**☣╎فـار رمـز الوقتـي غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الرمـز استخـدم الامـر : ↶**\n `.اضف فار رمز الوقتي` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if variable is None:
            await ze.edit("**☣╎فـار التحقق بخطوتين غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الرمـز استخـدم الامـر : ↶**\n `.اضف فار التحقق`  **بالـرد ع كـود التحـقق**\n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if variable is None:
            await ze.edit("**☣╎فـار البايـو الوقتـي غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع نـص استخـدم الامـر : ↶**\n `.اضف فار البايو` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = "TG_BOT_USERNAME"
        if variable not in heroku_var:
            await ze.edit("**☣╎فـار معرف البوت غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع المعرف استخـدم الامـر : ↶**\n `.اضف فار معرف البوت` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = "AUTONAME"
        if variable not in heroku_var:
            await ze.edit("**☣╎فـار الاسـم التلقائي غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الاسم استخـدم الامـر : ↶**\n `.اضف فار اسمي التلقائي` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if variable is None:
            await ze.edit("**☣╎فـار صـورة الحمايـة غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع صـورة فقـط استخـدم الامـر : ↶**\n `.اضف صورة الحماية` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = gvarstatus("DIGITAL_PIC")
        if variable is None:
            await ze.edit("**☣╎فـار صـورة الوقتـي غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع صـورة فقـط استخـدم الامـر : ↶**\n `.اضف صورة الوقتي` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if variable is None:
            await ze.edit("**☣╎فـار صـورة الفحص غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع صـورة فقـط استخـدم الامـر : ↶**\n `.اضف صورة الفحص` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if variable is None:
            await ze.edit("**☣╎فـار صـورة ستـارت البـوت غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع صـورة فقـط استخـدم الامـر : ↶**\n `.اضف صورة البوت` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if variable is None:
            await ze.edit("**☣╎فـار صـورة الاوامـر غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع صـورة فقـط استخـدم الامـر : ↶**\n `.اضف صورة الاوامر` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = gvarstatus("ALIVE_PIC")
        if variable is None:
            await ze.edit("**☣╎فـار صـورة السـورس غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع صـورة فقـط استخـدم الامـر : ↶**\n `.اضف صورة السورس` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if variable not in heroku_var:
            await ze.edit("**☣╎فـار رسـائل الحمايـة غيـر موجـود ❌**\n**☣╎لـ اضـافته فقـط استخـدم الامـر : ↶**\n `.اضف فار رسائل الحماية` بالـرد ع عـدد فقـط \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if variable is None:
            await ze.edit("**☣╎فـار زخرفـة الصـورة الوقتيـة غيـر موجـود ❌**\n**☣╎لـ اضـافته فقـط استخـدم الامـر : ↶**\n `.وقتي 1` الـى `.وقتي 17` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = "TZ"
        if variable not in heroku_var:
            await ze.edit("**☣╎فـار المنطقـه الزمنيـه غيـر موجـود ❌**\n**☣╎لـ اضـافته فقـط استخـدم الامـر : ↶**\n `.وقت` واسـم الدولـة \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = gvarstatus("CUSTOM_ALIVE_TEXT")
        if variable is None:
            await ze.edit("**☣╎فـار نص عنـوان كليشـة الايـدي غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الرمـز استخـدم الامـر : ↶**\n `.اضف فار عنوان الايدي` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = gvarstatus("CUSTOM_ALIVE_FONT")
        if variable is None:
            await ze.edit("**☣╎فـار خطـوط كليشـة الايـدي غيـر موجـود ❌**\n**☣╎لـ اضـافته بالـرد ع الرمـز استخـدم الامـر : ↶**\n `.اضف فار خطوط الايدي` \n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        if gvarstatus("Z_AK") is None:
            await ze.edit("**☣╎المتغيـر غيـر موجـود ❌**\n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎المتغيـر {} موجـود ☑️**\n**☣╎قيمـة المتغيـر : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
        ...
        variable = "SPAMWATCH_API"
        if variable not in heroku_var:
            await ze.edit("**☣╎فـار توكـن المكـافح غيـر موجـود ❌**\n\n**☣╎قنـاة السـورس : @source_ze**")
        else:
            await ze.edit("**☣╎الفـار {} موجـود ☑️**\n**☣╎قيمـة الفـار : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, variable))
...
# Copyright (C) 2023 Ze . All Rights Reserved
@zeub.ze_cmd(pattern="اضف صورة (الحماية|الحمايه|الفحص|الوقتي|البوت|الستارت|ستارت) ?(.*)")
async def _(malatha):
    if malatha.fwd_from:
        return
    ze = await edit_or_reply(malatha, "**☣╎جـاري اضـافة فـار الصـورة الـى بـوتك ...**")
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            await ze.edit(f"** ⪼ تم تحميل** {downloaded_file_name} **.. بنجـاح ✓**")
            ...
            try:
                ...
                await ze.edit("**☣╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**☣╎المتغيـر : ↶**\n `{}` \n\n**☣╎قنـاة السـورس : @source_ze**".format(input_str, vinfo))
...
# Copyright (C) 2023 Ze . All Rights Reserved
@zeub.ze_cmd(pattern="اضف صوره (الحماية|الحمايه|الفحص|الوقتي|البوت|الستارت|ستارت) ?(.*)")
async def _(malatha):
    if malatha.fwd_from:
        return
    ze = await edit_or_reply(malatha, "**☣╎جـاري اضـافة فـار الصـورة الـى بـوتك ...**")
...
# Copyright (C) 2023 Ze . All Rights Reserved
@zeub.ze_cmd(pattern="اوامر الفارات")
async def cmd(modyyy):
    await edit_or_reply(modyyy, ModyVP_cmd)

@zeub.ze_cmd(pattern="الفارات")
async def cmd(modyyy):
    await edit_or_reply(modyyy, ModyVP_cmd)