...
MODY_RIGHTS = ChatBannedRights(until_date=None, view_messages=True, send_messages=True, send_media=True, send_stickers=True, send_gifs=True, send_games=True, send_inline=True, embed_links=True)
...
CHANNELS_STR = "𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
CHANNELS_ADMINSTR = "𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - احصـائيـات جميـع القنـوات اشـراف** 𓆪\n\n"
CHANNELS_OWNERSTR = "𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - احصـائيـات جميـع القنـوات ملكيـة** 𓆪\n\n"
GROUPS_STR = "𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - احصـائيـات جميـع المجمـوعـات** 𓆪\n\n"
GROUPS_ADMINSTR = "𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - احصـائيـات جميـع المجمـوعـات اشـراف** 𓆪\n\n"
GROUPS_OWNERSTR = "𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - احصـائيـات جميـع المجمـوعـات ملكيـة** 𓆪\n\n"
# =========================================================== #
#                                                           ZE                                                                #
# =========================================================== #
...
async def ban_user(chat_id, i, rights):
    try:
        await zeub(functions.channels.EditBannedRequest(chat_id, i, rights))
        return True, None
...
async def stats(event):  # sourcery no-metrics
    ...
    response = f"𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - احصـائيـات {full_name}** 𓆪\n"
...
@zeub.ze_cmd(pattern="تجميع الاعضاء$")
...
@zeub.ze_cmd(pattern="اضف الاعضاء$")
...
async def get_users(show):
    ...
    zeevent = await edit_or_reply(show, "**☣╎جـارِ سحـب قائمـة معرّفـات الأعضـاء 🝛**")
    try:
        ...
        mentions += f" {str(e)}" + "\n"
    await edit_or_reply(zeevent, mentions)
...
async def info(event):
    ...
    zeevent = await edit_or_reply(event, "**☣╎جـارِ جلـب معلومـات الدردشـة، إنتظـر ⅏**")
    chat = await get_chatinfo(event, zeevent)
    if chat is None:
        return
    caption = await fetch_info(chat, event)
    try:
        await zeevent.edit(caption, parse_mode="html")
    except Exception as e:
        if BOTLOG:
        ...
        await zeevent.edit("**☣╎حـدث خـطأ مـا، يرجـى التحقق من الأمـر ⎌**")


async def get_chatinfo(event, zeevent):
    ...
    try:
        ...
        try:
            ...
            await zeevent.edit("**☣╎لـم يتـمّ العثـور على القنـاة/المجموعـة ✕**")
            return None
            ...
            await zeevent.edit("**☣╎القنـاة أو المجموعـة الخارقـة غيـر موجـودة ✕**")
            return None
        except (TypeError, ValueError) as err:
            LOGS.info(err)
            await edit_delete(zeevent, "**☣╎لم يتم العثور على المجموعة او القناة**")
            return None
    return chat_info
...
async def _(event):  # sourcery no-metrics
    ...
    async for i in event.client.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"""
        ...
        await sleep(5)
    await et.edit(
        """𓆰 𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻
➥ **العدد ↫ {} **مستخدماً
➥ **الحسابات المحذوفه ↫** {}
➥ **اخر ظهور منذ زمن طويل ↫** {}
➥ **اخر ظهور منذ شهر ↫** {}
...
@zeub.ze_cmd(pattern=r"مسح المحظورين(.*)")
async def _(event):
    zeevent = await edit_or_reply(event, "**☣╎ إلغاء حظر جميع الحسابات المحظورة في هذه المجموعة 🆘**")
    succ = 0
    total = 0
    flag = False
    chat = await event.get_chat()
    async for i in event.client.iter_participants(event.chat_id, filter=ChannelParticipantsKicked, aggressive=True):
        ...
        try:
            ...
            await zeevent.edit(f"**☣╎{readable_time(e.seconds)} مطلـوب المـعاودة مـرة اخـرى للـمسح 🔁 **")
            await sleep(e.seconds + 5)
        except Exception as ex:
            await zeevent.edit(str(ex))
        else:
            succ += 1
            if flag:
                await sleep(2)
            ...
            try:
                if succ % 10 == 0:
                    await zeevent.edit(f"**☣╎جـارِ مسـح المحـظورين ⭕️  : \n {succ} الحسـابات الـتي غيـر محظـورة لحـد الان.**")
            except MessageNotModifiedError:
                pass
    await zeevent.edit(f"**☣╎تـم مسـح المحـظورين مـن أصـل 🆘 :**{succ}/{total} \n اسـم المجـموعـة 📄 : {chat.title}")

@zeub.ze_cmd(pattern=r"المحذوفين ?([\s\S]*)")
...
async def count(event):
    ...
    result += f"𓆩 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 **- 🝢 - احصـائيـات الحسـاب** 𓆪\n"
...
@zeub.ze_cmd(pattern="الرابط ?(.*)")
async def ze(event):
    zeevent = await edit_or_reply(event, "**⇜ جـارِ جلـب رابـط المجموعـه ⇜**")
    chat = await event.get_chat()
    try:
        ...
        return await edit_delete(zeevent, "**☣╎عـذراً عـزيـزي .. انت لسـت مشرفـاً هنـا 🙇🏻**", 5)
    await zeevent.edit(f"**☣╎رابـط الـمجموعـه ⎋:**\n\n⎌ [{chat.title}]({ZL.link}) ⎌")   
    
@zeub.ze_cmd(pattern="رسائلي ?(.*)")
async def ze(event):
...
@zeub.ze_cmd(pattern="الحاظرهم$")
async def main(event):
    result = await zeub(functions.contacts.GetBlockedRequest(offset=0, limit=1000000))
    alist = []
    for user in result.users:
        if not user.bot:
            ...
            alist.append(zzz)
    if alist:
        await zeub.send_message("me", "\n".join(alist))

@zeub.ze_cmd(pattern="قيد (.*)")
async def _(event):
    exe = event.text[5:]
    try:
        result = await zeub(
...
@zeub.ze_cmd(pattern="احذف (.*)")
async def _(event):
    exe = event.text[5:]
    await zeub.get_dialogs()
    chat = exe
    await zeub.delete_dialog(chat, revoke=True)
    await event.edit("**☣╎تم حذف الدردشة مع المستخدم .. بنجـاح ✓**")

@zeub.ze_cmd(pattern="رسائله ?(.*)")
async def ze(event):
    k = await event.get_reply_message()
    if k:
        a = await bot.get_messages(event.chat_id, 0, from_user=k.sender_id)
