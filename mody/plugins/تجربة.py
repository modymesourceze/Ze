...
@zeub.ze_cmd(pattern="امر التجربه")
async def hi(event):
    await edit_or_reply(
        event,
        "**[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - تنفيــذ الاكــواد](t.me/source_ze)\n⋆─┄─┄─┄──┄─┄─┄─⋆**\n\n الامر: `.تجربه` + كود برمجي\n- يقوم بتشغيل الكود و أظهار النتيجة",
        link_preview=False,
    )


@zeub.ze_cmd(pattern="تجربه(?:\s|$)([\s\S]*)")
async def _(event):
    ...
    ze = await edit_or_reply(event, "**- جار تنفيـذ الكـود .. انتظـر**")
