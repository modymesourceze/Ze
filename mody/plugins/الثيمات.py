...
from ze.malath.theem import *

from . import *

@zeub.ze_cmd(pattern="ث1$")
...
async def stsTHMAT(lon):
    ...
    if sts_attheme2:
        ze_c = f"**{THMAT}**\n"
        await lon.client.send_file(lon.chat_id, sts_attheme2, caption=ze_c, reply_to=lonid)


@zeub.ze_cmd(pattern="ث3$")
...
@zeub.ze_cmd(pattern="ث7$")
async def stsTHMAT(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_attheme7:
        tumc = f"**{THMAT}**\n"
        await ze.client.send_file(
            ze.chat_id, sts_attheme7, caption=tumc, reply_to=reply_to_id
        )
        
        
@zeub.ze_cmd(pattern="ث8$")
async def stsTHMAT(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_attheme8:
        tumc = f"**{THMAT}**\n"
        await ze.client.send_file(
            ze.chat_id, sts_attheme8, caption=tumc, reply_to=reply_to_id
        )
        
@zeub.ze_cmd(pattern="ث9$")
async def stsTHMAT(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_attheme9:
        tumc = f"**{THMAT}**\n"
        await ze.client.send_file(
            ze.chat_id, sts_attheme9, caption=tumc, reply_to=reply_to_id
        )

@zeub.ze_cmd(pattern="ث10$")
async def stsTHMAT(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_attheme10:
        tumc = f"**{THMAT}**\n"
        await ze.client.send_file(
            ze.chat_id, sts_attheme10, caption=tumc, reply_to=reply_to_id
        )
        
@zeub.ze_cmd(pattern="ث11$")
async def stsTHMAT(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_attheme11:
        tumc = f"**{THMAT}**\n"
        await ze.client.send_file(
            ze.chat_id, sts_attheme11, caption=tumc, reply_to=reply_to_id
        )
        
@zeub.ze_cmd(pattern="ث12$")
async def stsTHMAT(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_attheme12:
        tumc = f"**{THMAT}**\n"
        await ze.client.send_file(
            ze.chat_id, sts_attheme12, caption=tumc, reply_to=reply_to_id
        )



@zeub.ze_cmd(pattern="ن1$")
...
async def stsfanan(lon):
    ...
    if sts_fanan2:
        ze_c = f"**{FANAN}**\n"
        ze_c += f"•━─━─━─━─🔱 𝐙𝐄 🔱─━─━─━─━•\n\n"
        ze_c += f"**➥ ثيم البشير شو HD غير مضر للعيون ❤️ ...**\n"
        ze_c += f"**➥ لـ تحميـل الثيـم ارســل ↫** `.ث2`"
        await lon.client.send_file(lon.chat_id, sts_fanan2, caption=ze_c, reply_to=lonid)


@zeub.ze_cmd(pattern="ن3$")
...
@zeub.ze_cmd(pattern="ن7$")
async def stsfanan(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_fanan7:
        ...
        await ze.client.send_file(
            ze.chat_id, sts_fanan7, caption=tumc, reply_to=reply_to_id
        )
        
        
@zeub.ze_cmd(pattern="ن8$")
async def stsfanan(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_fanan8:
        ...
        await ze.client.send_file(
            ze.chat_id, sts_fanan8, caption=tumc, reply_to=reply_to_id
        )
        
@zeub.ze_cmd(pattern="ن9$")
async def stsfanan(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_fanan9:
        ...
        await ze.client.send_file(
            ze.chat_id, sts_fanan9, caption=tumc, reply_to=reply_to_id
        )

@zeub.ze_cmd(pattern="ن10$")
async def stsfanan(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_fanan10:
        ...
        await ze.client.send_file(
            ze.chat_id, sts_fanan10, caption=tumc, reply_to=reply_to_id
        )
        
@zeub.ze_cmd(pattern="ن11$")
async def stsfanan(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_fanan11:
        ...
        await ze.client.send_file(
            ze.chat_id, sts_fanan11, caption=tumc, reply_to=reply_to_id
        )
        
@zeub.ze_cmd(pattern="ن12$")
async def stsfanan(ze):
    if ze.fwd_from:
        return
    reply_to_id = await rd(ze)
    if sts_fanan12:
        ...
        await ze.client.send_file(
            ze.chat_id, sts_fanan12, caption=tumc, reply_to=reply_to_id
        )


@zeub.ze_cmd(pattern="ثيمات")
async def ze(zelzal):
    await edit_or_reply(zelzal, ZL)

@zeub.ze_cmd(pattern="الثيمات")
async def ze(zelzal):
    await edit_or_reply(zelzal, ZL)
