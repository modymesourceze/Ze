...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        query = event.text
        await zeub.get_me()
        if query.startswith("مساعده") and event.query.user_id == zeub.uid:
            buttons = [
                ...
                [
                    ...
                    Button.inline(" الفـارات 🛂", data="varsze"),
                ],
                [
                    Button.inline("التسليـه والتحشيش 🎃", data="funze"),
                ],
                [
                    Button.inline("المرفقـات 🪁", data="extras"),
                    Button.inline("الادوات 💡", data="toolze"),
                ],
                [
...
@zeub.ze_cmd(pattern="مساعده")
async def help(event):
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await zeub.inline_query(Config.TG_BOT_USERNAME, "مساعده")
    await response[0].click(event.chat_id)
    await event.delete()


@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"ZEHELP")))
@check_owner
async def _(event):
    butze = [
        [Button.inline("البـحـث والتحميـل 🪄", data="zdownload")],
    ...
    try:
        await event.edit(
            ...
            buttons=[
                ...
                [Button.inline("رجوع", data="ZEHELP")],
            ],
        link_preview=False)
    except Exception:
        await event.answer(mody, cache_time=0, alert=True)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zzcall")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المكالمـات والميـوزك 🎸](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zzmusic")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المكالمـات والميـوزك 🎸](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"superzzz")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر النشـر والسوبـرات :**\n\n",
        buttons=[
            [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"spamzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر النشــر التلقــائي 🌐](t.me/source_ze  ) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"superrzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 - النشـر التڪـراري العـام (الـسوبـرات) 🎡](t.me/source_ze) .
**⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pointzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر تجميــع النقــاط 🛂](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zchatgpt")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الذكـاء الاصطنـاعـي 🛸](t.me/source_ze) .
**- الامـر :**
...
############ البوت ############
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"botvr")))
@check_owner
async def _(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
                ...
                [
                    Button.inline("الفحص", data="alivze"),
                ],
                [
                    Button.inline("السليب (النوم)", data="sleep"),
                    Button.inline("سرعة الانترنت", data="netze"),
                ],
                [
                    Button.inline("نظـام البـوت", data="sysze"),
                ],
                [
                    Button.inline("سورس", data="sourcevr"),
                    Button.inline("زد إي", data="zevr"),
                ],
                [
                ...
                [Button.inline("رجــوع", data="ZEHELP")],
            ],
        link_preview=False)
    except Exception:
        await event.answer(mody, cache_time=0, alert=True)
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"sysze")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - ادوات النظــام 🤖](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر نظـام البـوت المسـاعد :**\n\n",
        buttons=[
            [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"syszzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
ارسـل الامـر   `.النظام`""",
        buttons=[
            [Button.inline("رجوع", data="sysze")],
        ],
    link_preview=False)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"rmzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"fszzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"envzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"datzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"updatevr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"resitvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"stopvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"alivze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"sleep")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"netze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"sourcevr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zevr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"ethaavr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"devvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البـــوت 🦾🤖](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"groupvr")))
@check_owner
async def _(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه 🛗](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
                ...
                [
                    Button.inline("التحذيرات", data="warnze"),
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"warnze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"group4vr")))
@check_owner
async def _(event):
    await event.edit(
        """**- الامـر :**
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"group5vr")))
@check_owner
async def _(event):
    await event.edit(
        """**- الامـر :**
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"group1vr")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹ 🛗](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه¹ :**\n\n",
        buttons=[
            ...
            [Button.inline("تقييـد المحتـوى", data="lolze")],
            [Button.inline("رجوع", data="groupvr")],
        ],
    link_preview=False)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"botveiw")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"botlock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"addlock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"golock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"medlock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"edmdlock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"urlock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"userlock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"forlock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"inilock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"farslock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"fuklock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"premlock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zerolock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"alllock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"setelock")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه¹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"lolze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"group2vr")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه² 🛗](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه² :**\n\n",
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"urlveiw")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"tagvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"addmnvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"creatorvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"msgvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"delmsgvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/source_ze) .
**- الامـر :**
**➥** `.حذف فار رسائلي`
**➥** `.مسح`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"iundlt")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"infoovr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"memver")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"creatorrvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"botssvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"photoadd")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pinvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zomby")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"delbans")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه²](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"group3vr")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³ 🛗](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه³ :**\n\n",
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"mutevr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"banvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"kickvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"tkkkvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"nospam")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر مكـافح التكــرار 🛡](t.me/source_ze) .
**- الامـر :**
**➥** `.ضع التكرار`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"noway")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المنــع 🚫](t.me/source_ze) .
**- الامـر :**
**➥** `.منع`
**➥** `.الغاء منع`
**➥** `.قائمة المنع`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"group0vr")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الاضـافه والتفليـش 👾](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"addvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zerovr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"banall")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"kickall")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"mutall")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"byby")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"banbot")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zoomby")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"dellbans")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المجمــوعــه³](t.me/source_ze) .
...
############ الفارات ############
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"varsze")))
@check_owner
async def _(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات 🧬](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"namevar")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر فــارات الوقتــي 🕰](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
            ...
            [Button.inline("رجوع", data="varsze")],
            [Button.inline("رجــوع", data="ZEHELP")],
        ],
    link_preview=False)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"contrytime")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"symnamvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"phovarlok")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"biolokvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"timevar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"nameprvr")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pmvars")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"warnvars")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pmvarkish")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"picpmvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"alivevar")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر فــارات الفحـص 🏮](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"picvars")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"kleshalive")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"rmzalive")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"sourcevar")))
@check_owner
async def ze_help(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - فـارات السـورس 🛰](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات بعـض اوامـر فـارات السـورس :**\n\n",
            buttons=[
                [
                ...
                [Button.inline("رجــوع", data="varsze")],
            ],
        link_preview=False)
    except Exception:
        await event.answer(mody, cache_time=0, alert=True)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"katmvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"startbotvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"rmsavar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"enoanvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"katvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"msrvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"yemenvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"syriavar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"timavar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pointvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الفــارات](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"zdownload")))
@check_owner
async def ze_help(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر البحث والتحميـل من جميـع مواقـع الـ سوشـل ميديـا :**\n\n",
            buttons=[
                [
                    Button.inline("فيديو", data="vedze"),
                    Button.inline("بحث", data="songze"),
                ],
                [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"songze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"vedze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"youini")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"downsou")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"downved")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"shazam")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"giff")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"stickkers")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pictures")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"youtubb")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"soundcloud")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"insta")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pentrist")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"likee")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"tiktok")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"facebook")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"tweter")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"snapchat")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"bookzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر تحميـل الكتب 📕](t.me/source_ze) .
**- الامـر :**
**➥** `.كتاب`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"savzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"storyzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر البحـث والتحميــل 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"telech")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر بحـث تيليـجـرام 🛰](t.me/source_ze) .
**- الامـر :**
**➥** `.تلي` **+ كلمـة**
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"telecg")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر بحـث تيليـجـرام 🛰](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"funze")))
@check_owner
async def _(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
                    Button.inline("اوامــر تسليـه متحركـه", data="fun1ze"),
                ],
                [
                    Button.inline("اوامــر تسليـه جديـدة", data="fun2ze"),
                ],
                [
                    Button.inline("اوامــر التحـشيش", data="fun3ze"),
                ],
                [
                    Button.inline("اوامــر الالعــاب", data="fun4ze"),
                ],
                [Button.inline("رجــوع", data="ZEHELP")],
            ],
        link_preview=False)
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"fun1ze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر التسليـه 🏂](t.me/source_ze) .
**➥** `.تسليه1`
**➥** `.تسليه2`
**➥** `.تسليه3`
**➥** `.تسليه4`
...
لا تقم بتكرار هذه الاوامـر او استخدامهـا بكثـره حتى لا يحدث تعليق لحسابك""",
        buttons=[
            [Button.inline("رجوع", data="funze")],
        ],
    link_preview=False)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"fun2ze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر التسليـه ⛹🏻‍♀](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"fun3ze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر التحشيش 🎃](t.me/source_ze) .
**- الامـر :**
**➥** `.رفع تاج`
**➥** `.رفع بقلبي`
**➥** `.رفع مرتي`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"fun4ze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الالـعــاب 🎮🎳](t.me/source_ze) .
**- الامـر :**
**➥** `.بلاي`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"acccount")))
@check_owner
async def ze_help(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات الاوامـر المتعلقـه بالحسـاب :**\n\n",
            buttons=[
                [
                ...
                [
                    Button.inline("رجـوع", data="ZEHELP"),
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"nextacc")))
@check_owner
async def ze_help(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات الاوامـر المتعلقـه بالحسـاب :**\n\n",
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"next2acc")))
@check_owner
async def ze_help(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات الاوامـر المتعلقـه بالحسـاب :**\n\n",
        buttons=[
            [
                Button.inline("الازعاج", data="echoze"),
                Button.inline("الانتحال", data="enthalze"),
            ],
            [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"profcmd")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"echoze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"enthalze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"gozzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"banzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"delzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"biome")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"namme")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"picme")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"channelme")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"groubme")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pmme")))
@check_owner
async def _(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر البحث والتحميـل من جميـع مواقـع الـ سوشـل ميديـا :**\n\n",
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pmcmd")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر حمـايــة الخــاص 🛡](t.me/source_ze) .
**➥** `.الحمايه تفعيل`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pmvar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - فــارات حمـايــة الخــاص 🛡](t.me/source_ze) .
**➥** `.اضف فار عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"infome")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"whome")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"logme")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"mutme")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"banme")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"whonam")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الحســاب 🚹](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"extras")))
@check_owner
async def ze_help(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المـرفقــات 🖥](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"meddia")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المـرفقــات 🖥](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"story")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الستـوريـات 🎆🏖](t.me/source_ze) .
**- الامـر :**
**➥** `.حالات واتس`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"avatar")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/source_ze) .
**- الامـر :**
**➥** `.بنات`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"stickerrs")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر المـرفقــات 🖥](t.me/source_ze) .
...
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامـر السبـام والتكـرار](t.me/ZTho) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"toolze")))
@check_owner
async def ze_help(event):
    mody = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ هـذه اللوحه لا تشتغل في الخاص\n⤶ لـ إظهـار لوحـة المسـاعـدة 👇\n\n⤶ ارســل (.مساعده) في اي مجمـوعـه"
    try:
        await event.edit(
            "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
                    Button.inline("الاشتـراك الاجبـاري", data="subsze"),
                ],
                [
                    Button.inline("الصيـد & الـتثبيت", data="huntze"),
                ],
                [
                    Button.inline("تجميـع النقـاط", data="pointze"),
                ],
                [
                    Button.inline("النشـر التلقائـي", data="nashze"),
                ],
                [
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"nexttools")))
@check_owner
async def ze_help(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
        buttons=[
            ...
            [
                Button.inline("الحاسبة", data="calcze"),
            ...
            [Button.inline("رجوع", data="toolze")],
        ],
    link_preview=False)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"thatia")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"scanner")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"calcze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"taks")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"transzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"creatzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"leavzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"scinczzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"urltools")))
@check_owner
async def ze_help(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - ادوات الروابــط 💡](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
                Button.inline("اختصـار الروابـط", data="shorturl"),
            ],
            [
                Button.inline("سكريـن", data="screenze"),
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"shorturl")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
**- مثـال :**
`.اختصار https://github.com/modymesourceze/Ze`
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"screenze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"viewzzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"dnszzz")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"hideurl")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الادوات 💡](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"subsze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/source_ze) .
**- الامـر :**
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"huntze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر الصيـد & الـتثبيت ❇️](t.me/source_ze) .
...
@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"pointze")))
@check_owner
async def ze_help(event):
    await event.edit(
        "[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر تجميـع النقـاط 💡](t.me/source_ze) .\n\n**☣╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
                Button.inline("نقـاط العـاب وعــد", data="wadze"),
            ],
            [Button.inline("رجوع", data="toolze")],
        ],
    link_preview=False)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"wadze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر تجميــع النقــاط 🛂](t.me/source_ze) .
...
`.راتب وعد 50`""",
        buttons=[
            [Button.inline("رجوع", data="pointze")],
        ],
    link_preview=False)

@zeub.tgbot.on(CallbackQuery(data=re.compile(rb"nashze")))
@check_owner
async def _(event):
    await event.edit(
        """[ᯓ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 𝐙𝐄 🔱 - اوامــر النشــر التلقــائي 🌐](t.me/source_ze  ) .
