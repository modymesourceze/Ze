...
class Config(object):
    ...
    # set this with required ze repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/modymesourceze/Ze"
    )
    ...
    OLDZE = os.environ.get("OLDZE", "no")
    OLDZE = bool(OLDZE and (OLDZE.lower() != "no"))
    ...
    CUSTOM_ALIVE_EMZE = os.environ.get("CUSTOM_ALIVE_EMZE", None)
    ...
    ZE_MEDIA = os.environ.get("ZE_MEDIA", None)
    ...
    # For updater plugin
    UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "ze")
    ...
    OLDZE_REPO = os.environ.get("OLDZE_REPO", "https://github.com/modymesourceze/ZESOURCE")
    if OLDZE_REPO and not url(OLDZE_REPO):
        OLDZE_REPO = "https://github.com/modymesourceze/ZESOURCE"
    OLDZE_REPOBRANCH = os.environ.get("OLDZE_REPOBRANCH", "oldZE")
    VC_REPO = os.environ.get("VC_REPO", "https://github.com/modymesourceze/ZVCPlayer")
